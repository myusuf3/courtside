...
def facebook_callback(request):
    ...
    try:
        player = Player.objects.get(facebook_id = facebook_user['id'])
    except:
        user = User(username= facebook_user['username'])
        ...
        player = Player()
        player.user = user
        player.gender = get_gender_initial(gender=facebook_user['gender'])
